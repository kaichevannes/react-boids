...
function SeparationWeighting() {
    ...
    return <SliderGroup name="Separation Weighting" state={Math.round(separationWeighting * 100) / 100} setState={setSeparationWeighting} min={0} max={1} step={0.01} />
};
